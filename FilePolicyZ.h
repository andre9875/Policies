#ifndef _FILE_POLICE_ZLIB_H_
#define _FILE_POLICE_ZLIB_H_
...
private:
   ...
   FileCompressZ& operator=(const FileCompressZ&); //disable assigment
   FileCompressZ(const FileCompressZ&);            //disable copy ctor
...
protected:
	...
	int bufsize;
	  ...
	  //~FileCompressZ() { delete[] buffer; } //the destructor is protected, only derived classes can destroy policy object
...
public:
	...
	FileCompressZ(int bufsize_ = 1024000) :
	  bufsize(bufsize_),
	  fRead(0),
	  fWrite(0)
	  {}
